...
export default function DialogAddExpenses() {
    const [valueInputs, setValueInputs] = React.useState({ title: "", price: 0, state: 'expenses' })
    ...
    return (
        <React.Fragment>
            ...
            <Dialog
                ...
                component={'form'}
            >
                <DialogTitle>Add expenses form</DialogTitle>
